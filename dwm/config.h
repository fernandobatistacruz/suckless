...
static const char *fonts[]          = { "sans:size=12", "FontAwesome:pixelsize=16:antialias=true:autohint=true" };
...
static const unsigned int baralpha = 245; /*0xd0*/
...
static const char *scrotcmd[]      = { "scrot", "-s", "-f", "-q", "100","/home/fernando/screenshots/%d-%m-%Y-%H-%M-%S.png", NULL };
